...
void kuutio::draw(float time)
{
    ...
    static float r = -300 - 50*(float)cos(framePosition*17) - framePosition * 100;

    Vector cam = sphereCoord(r, a*3.141592f+framePosition*0.7f, b*3.141592f*2);
